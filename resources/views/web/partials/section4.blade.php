{{-- <div class="bg-white">
    <!-- Header -->
    <div class="relative bg-white pb-32">
      ...
      <div class="relative mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8">
        ...
        <p class="mt-6 max-w-3xl font-semibold text-xl text-gray-200">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames. Dui, amet, nec sit pulvinar.</p>
      </div>
    </div>
    ...
    <section class="relative z-10 mx-auto -mt-32 max-w-7xl px-6 pb-32 lg:px-8" aria-labelledby="contact-heading">
      ...
      <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
        ...
        <div class="flex flex-col rounded-2xl bg-slate-800 shadow-xl">
          <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
            ...
            <h3 class="text-xl font-medium text-white">Sales</h3>
            <p class="mt-4 text-base text-gray-400">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>
          </div>
        ...
        <div class="flex flex-col rounded-2xl bg-slate-800 shadow-xl">
          <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
            ...
            <h3 class="text-xl font-medium text-white">Technical Support</h3>
            <p class="mt-4 text-base text-gray-400">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>
          </div>
          <div class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8">
            <a href="#" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Contact us<span aria-hidden="true"> &rarr;</span></a>
        ...
        <div class="flex flex-col rounded-2xl bg-slate-800 shadow-xl">
          <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
            ...
            <h3 class="text-xl font-medium text-white">Media Inquiries</h3>
            <p class="mt-4 text-base text-gray-400">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>
          </div>
          <div class="rounded-bl-2xl rounded-br-2xl bg-gray-50 p-6 md:px-8">
            <a href="#" class="text-base font-medium text-indigo-700 hover:text-indigo-600">Contact us<span aria-hidden="true"> &rarr;</span></a>
        ...
        <div class="flex flex-col rounded-2xl bg-slate-800 shadow-xl mt-24">
            <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
              <div class="absolute top-0 inline-block -translate-y-1/2 transform rounded-xl bg-indigo-600 p-5 shadow-lg">
                <!-- Heroicon name: outline/phone -->
                <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
